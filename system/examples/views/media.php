...
<?php else: ?>
<object width="<?php echo $media->getStandardResVideo()->width ?>" height="<?php echo $media->getStandardResVideo()->height ?>" type="application/x-shockwave-flash" data="public/images/jwplayer.swf">
<param name="movie" value="public/images/jwplayer.swf">
...
<?php endif; ?>
<form id="like" action="?example=media.php&media=<?php echo $media_id ?>" method="post">
