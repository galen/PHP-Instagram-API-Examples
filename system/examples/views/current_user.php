...
<li><a href="?example=media.php&media=<?php echo $liked_m->getId() ?>"><img src="<?php echo $liked_m->getThumbnail()->url ?>"><?php if( $liked_m->getType() == 'video' ): ?><img src="public/images/play.png" class="play"><?php endif; ?></a></li>
<?php endforeach; ?>
</ul>
...
<li><a href="?example=media.php&media=<?php echo $f->getId() ?>"><img src="<?php echo $f->getThumbnail()->url ?>" title="Posted by <?php echo $f->getUser() ?>"><?php if( $f->getType() == 'video' ): ?><img src="public/images/play.png" class="play"><?php endif; ?></a></li>
<?php endforeach; ?>
</ul>
