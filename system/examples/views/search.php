...
<div id="search_forms">
	...
	<div id="users_wrapper" class="search_form_wrapper<?php if( isset( $media ) ): ?> active<?php endif; ?>">
		<h2>Search Media</h2>
		<div class="map_wrapper"><div id="map_media" class="map"></div><img src="/projects/instagram/public/images/crosshair.gif" class="crosshairs"></div>
		<form action="">
			<input type="hidden" name="example" value="search.php">
	...
	<div id="users_wrapper" class="search_form_wrapper<?php if( isset( $locations ) ): ?> active<?php endif; ?>">
		...
		<div class="map_wrapper"><div id="map_locations" class="map"></div><img src="/projects/instagram/public/images/crosshair.gif" class="crosshairs"></div>
		<form action="">
			<input type="hidden" name="example" value="search.php">
